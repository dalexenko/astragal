...
"HEXDUMP PREVIEW"=>"ПЕРДПРОСМОТР В 16-РИЧНОМ ВИДЕ",
...
//   echo " onMouseOver='this.style.value=\\\"line2\\\"' onMouseOut='this.style.value=\\\"line\\\"'>";
   ...
   //<tr><td colspan='.strlen($cn).' bgcolor=white> 
   //askj klsdjf sldkjfl kasj flkajsd lkfjasdlkf jalskdfj lkas jfklasjlksdjfl <br><br><br><br><br><br><br><br>
...
case "v":
   ...
   case 4: // session
      ...
      echo "</pre><hr size=1 noshade><pre>";
...
<input type=submit><br>";
   ...
   $russtr1="QWERTYUIOPASDFGHJKLZCVBNMqwertyuiopasdfghjklzcvbnm'#";
   $russtr2="КВЕРТЫУИОПАСДФГХЙКЛЗЦВБНМквертыуиопасдфгхйклзцвбнмьъ";
   ...
   function to_translit($ss) {
      global $russtr1,$russtr2;
      return strtr($ss,$russtr2,$russtr1);
   }
